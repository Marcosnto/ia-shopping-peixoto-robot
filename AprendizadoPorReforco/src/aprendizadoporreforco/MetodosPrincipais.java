...
public class MetodosPrincipais {
    ...
    public static int TOTALESTADOS = 41;
    //utilizada para saber a quantidade de estados 
    ...
    public static void mostrarTabela() {
        System.out.printf("%-10s", "Estado", "Acao", "Destino", "Valor ");
        System.out.printf("%-10s", "Acao", "Destino", "Valor ");
        System.out.printf("%-10s", "Acao", "Destino", "Valor ");
        System.out.printf("%-10s", "Acao", "Destino", "Valor ");
        System.out.println("");
        for (int i = 0; i < TOTALESTADOS; i++) {
            ...
            for (int j = 0; j < TOTALACOES; j++) {
                if (j == 0) {
                    System.out.printf("%-10s", "Esquerda", tabela[i][j].getEstado(), String.format("%.5f", tabela[i][j].getValorAcao()));
                } else if (j == 1) {
                    System.out.printf("%-10s", "Direita", tabela[i][j].getEstado(), String.format("%.5f", tabela[i][j].getValorAcao()));
                } else if (j == 2) {
                    System.out.printf("%-10s", "Cima", tabela[i][j].getEstado(), String.format("%.5f", tabela[i][j].getValorAcao()));
                } else if (j == 3) {
                    System.out.printf("%-10s", "Baixo", tabela[i][j].getEstado(), String.format("%.5f", tabela[i][j].getValorAcao()));
                }
            }
            System.out.println("");
        }
